      ...
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div className={styles.modalInner}>
          ...
          <div className={styles.header}>
            <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-apr-15-2026-07_26_42-pm.png" alt="Safe Trade" className={styles.safeTradeLogo} />
          ...
          <div className={styles.section}>
            <div className={styles.methodExplain}>
              <div className={styles.methodLogoWrap}>
                <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitledsdfsdfs-removebg-preview.png" alt="PayPal" className={styles.methodLogo} />
              </div>
          ...
          <div className={styles.section}>
            <div className={styles.methodExplain}>
              <div className={styles.methodLogoWrap}>
                <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitledsdfsdfsdasd-removebg-preview.png" alt="Escrow" className={styles.methodLogo} />
              </div>
              <div className={styles.methodDetail}>
