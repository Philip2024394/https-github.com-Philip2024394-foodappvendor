...
function DeliveryChat({ driverName, chatKey, initialMessages, onClose }) {
  ...
  return createPortal(
    <div style={{ position: 'fixed', inset: 0, zIndex: 10010, backgroundColor: '#0a0a0a', display: 'flex', flexDirection: 'column' }}>
      <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-apr-27-2026-06_12_16-am.png?updatedAt=1777245159090" alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', pointerEvents: 'none', zIndex: 0 }} />
      {/* Header */}
    ...
    <div className={styles.screen}>
      ...
      >
        ...
        <div className={styles.cartBadgeTop}>
          <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitleddasdasdasdasss-removebg-preview.png" alt="Cart" style={{ width: 28, height: 28, objectFit: 'contain' }} />
        ...
        <div className={styles.cartPage}>
              ...
              <>
                ...
                {(deliveryFare ?? 0) > 0 && (
                  <div className={styles.cartPageItem} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/sleek-green-and-black-scooter-setup.png" alt="" style={{ width: 36, height: 36, objectFit: 'contain', flexShrink: 0 }} />
                    <div style={{ flex: 1 }}>
                ...
                <div style={{ marginBottom: 12 }}>
                  <div style={{ padding: '14px', borderRadius: 14, background: 'rgba(0,0,0,0.4)', border: '1.5px solid rgba(141,198,63,0.2)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                      <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/mmma-removebg-preview.png?updatedAt=1777002391090" alt="COD" style={{ width: 48, height: 48, objectFit: 'contain' }} />
                      <div>
          ...
          {cart.length > 0 && (
            <div className={styles.cartPageFooter}>
              ...
              >
                <img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/dfggdfgees-removebg-preview.png" alt="" />
